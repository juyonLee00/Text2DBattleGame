...
namespace Text2DBattleGame
{
    ...
    internal class Program
    {
        ...
        public static List<IItem> normalTable = new List<IItem>() { new AttackItem("노말아이템", "test", false, 1, 1, 1, 1, ItemType.Attack, 0) };

        public static List<IItem> rareTable = new List<IItem>() { new AttackItem("레어아이템", "test", false, 1, 1, 1, 1, ItemType.Attack, 0) };

        public static List<IItem> UniqueTable = new List<IItem>() { new AttackItem("유니크아이템", "test", false, 1, 1, 1, 1, ItemType.Attack, 0) };
